                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select * from rezervasyon where kid=2 and gg=1";
                                            ...
                                            <div class='modal-dialog'>
                                                <div class='modal-content' data-border-top='multi' style='border-top: 0px;'>
                                                    ...
                                                    <div class='modal-header alert alert-warning'>
                                                        <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button>
                                                        <h4 class='modal-title' id='small-modal-label'>REZERVASYON TAMAMLAMA FORMU</h4>
                                                    </div>
                                                    ...
                                                    <input type='hidden' name='id' value=".$rezervasyon['id']." >
                                                        <div class='modal-body'>
                                                            ...
                                                            <h3>Rezervasyon Tamamlandı Mı?</h3>
                                                        </div>
                                                        <div class='modal-footer'>
